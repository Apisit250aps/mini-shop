...
export { companySchema, branchSchema, departmentSchema, userBranchSchema, userDepartmentSchema };
export type { CompanyEntity, BranchEntity, DepartmentEntity, UserBranchEntity, UserDepartmentEntity };